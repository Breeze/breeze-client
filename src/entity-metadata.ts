...
export class MetadataStore {
  ...
  **/
  ...
  /** @hidden @internal */
  _resourceEntityTypeMap: ObjMap<string>; 
  /** @hidden @internal */
  _entityTypeResourceMap: ObjMap<string>;
  /** @hidden @internal */
  _structuralTypeMap: ObjMap<StructuralType>; // key is qualified structuraltype name - value is structuralType. ( structural = entityType or complexType).
  /** @hidden @internal **/
  _shortNameMap: ObjMap<string>; // key is shortName, value is qualified name - does not need to be serialized.
  /** @hidden @internal **/
  _ctorRegistry: ObjMap<any>; // key is either short or qual type name - value is ctor;
  /** @hidden @internal **/
  _incompleteTypeMap: ObjMap<NavigationProperty[]>; // key is entityTypeName; value is array of nav props
  /** @hidden @internal **/
  _incompleteComplexTypeMap: ObjMap<DataProperty[]>; //
  /** @hidden @internal **/
  _deferredTypes: ObjMap<any>;
  // { json: json, stype: stype }
  /** @hidden @internal **/
  _id: number;
...
function getTypesFromMap(typeMap: ObjMap<StructuralType>) {
...
export class DataProperty {
  ...
  */
  ...
  static getRawValueFromServer(rawEntity: ObjMap<any>, dp: DataProperty) {
    if (dp.isUnmapped) {
  ...
  static getRawValueFromClient(rawEntity: ObjMap<any>, dp: DataProperty) {
    let val = rawEntity[dp.name];
    return val !== undefined ? val : dp.defaultValue;
  }

  resolveProperty(propName: string) {
    let result = (this as ObjMap<any>)[propName];
    let baseProp = this.baseProperty as ObjMap<any>;
...
BreezeEnum._dump =  AutoGeneratedKeyType.resolveSymbols();
...
function addProperties(entityType: StructuralType, propObj: ObjMap<any> | undefined, ctor: any) {
